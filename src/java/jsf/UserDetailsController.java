...
import jpa.entities.UserDetails;
import jsf.util.JsfUtil;
import jsf.util.JsfUtil.PersistAction;
import jpa.session.UserDetailsFacade;
...
public class UserDetailsController implements Serializable {
    ...
    @EJB
    private jpa.session.UserDetailsFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("UserDetailsCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("UserDetailsUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("UserDetailsDeleted"));
        if (!JsfUtil.isValidationFailed()) {
